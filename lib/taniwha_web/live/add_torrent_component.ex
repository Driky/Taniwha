        ...
        >
          ...
          >
            <form
              ...
              phx-change="validate"
              id={"#{@id}-file-form"}
              class="flex flex-col items-center border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-[10px] px-5 py-8 text-center cursor-pointer"
            >
              <.icon name="hero-arrow-up-tray" class="size-8 text-gray-400 mb-3" />
              <p class="text-[12px] text-gray-500 mb-1">Drag and drop your .torrent file here</p>
              <.live_file_input
                upload={@file_uploads.torrent_file}
